...
def configure_samples():
  ...
  d_samp = {
    ...
    'top'      :{'type':'bkg', 'leg':'t#bar{t} & Single top',       'f_color':myLightBlue,   'path':'top_SusySkimHiggsino_v1.9_hadded_tree.root'},
    #'Zttjets'  :{'type':'bkg', 'leg':'Z(#rightarrow#tau#tau)+jets', 'f_color':myMediumGreen,  'path':'Zttjets'+bkg_suffix},
    'Zttjets'  :{'type':'bkg', 'leg':'Z(#rightarrow#tau#tau)+jets', 'f_color':myMediumGreen,  'path':'Zttjets_SusySkimHiggsino_v1.9_hadded_tree.root'},
    #'diboson'  :{'type':'bkg', 'leg':'Diboson',                     'f_color':myMediumOrange, 'path':'diboson'+bkg_suffix},
    'diboson'  :{'type':'bkg', 'leg':'Diboson',                     'f_color':myMediumOrange, 'path':'diboson_SusySkimHiggsino_v1.9_hadded_tree.root'},
    #'other'    :{'type':'bkg', 'leg':'Others',                       'f_color':myLighterOrange,'path':'other'+bkg_suffix},
    'other'    :{'type':'bkg', 'leg':'Others',                       'f_color':myLighterOrange,'path':'other_SusySkimHiggsino_v1.9_hadded_tree.root'},
...
#    'MGPy8EG_A14N23LO_NUHM2_m12_800_weak_2LMET50_MadSpin':{'type':'sig','leg':'NUHM2 m12=800','l_color':kRed-6,'path':'MGPy8EG_A14N23LO_NUHM2_m12_800_weak_2LMET50_MadSpin'+sig_suffix},
    ...
    'MGPy8EG_A14N23LO_SM_Higgsino_160_100_2LMET50_MadSpin':{'type':'sig','leg':'#tilde{H} [160, 100]','l_color':kViolet+1,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_SM_Higgsino_160_150_2LMET50_MadSpin':{'type':'sig','leg':'#tilde{H} [160, 150]','l_color':kViolet+2,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_SM_Higgsino_170_150_2LMET50_MadSpin':{'type':'sig','leg':'#tilde{H} [170, 150]','l_color':kViolet+3,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_SM_Higgsino_190_150_2LMET50_MadSpin':{'type':'sig','leg':'#tilde{H} [190, 150]','l_color':kViolet+4,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},

    'MGPy8EG_A14N23LO_NUHM2_m12_300_weak':{'type':'sig','leg':'NUHM2 m12=300','l_color':kRed,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_NUHM2_m12_350_weak':{'type':'sig','leg':'NUHM2 m12=350','l_color':kRed-1,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_NUHM2_m12_400_weak':{'type':'sig','leg':'NUHM2 m12=400','l_color':kRed-2,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_NUHM2_m12_500_weak':{'type':'sig','leg':'NUHM2 m12=500','l_color':kRed-3,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_NUHM2_m12_600_weak':{'type':'sig','leg':'NUHM2 m12=600','l_color':kRed-4,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_NUHM2_m12_700_weak':{'type':'sig','leg':'NUHM2 m12=700','l_color':kRed-5,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
    'MGPy8EG_A14N23LO_NUHM2_m12_800_weak':{'type':'sig','leg':'NUHM2 m12=800','l_color':kRed-6,'path':'AllSignals_SusySkimHiggsino_v1.9b_SUSY16_tree_AllSys.root'},
