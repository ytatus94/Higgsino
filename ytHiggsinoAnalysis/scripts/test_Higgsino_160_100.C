...
void test_Higgsino_160_100()
{
    ...
    // TFile *f_Higgsino_N2N1 = new TFile(file_Higgsino_N2N1.c_str());
    // TFile *f_Higgsino_C1C1 = new TFile(file_Higgsino_C1C1.c_str());
    // TFile *f_Higgsino_N2C1p = new TFile(file_Higgsino_N2C1p.c_str());
    // TFile *f_Higgsino_N2C1m = new TFile(file_Higgsino_N2C1m.c_str());
